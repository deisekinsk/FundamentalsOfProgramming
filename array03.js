...
var b = 2020 - a;
var myVector = ["Job","in",123,2020, b];
...
var myVector = myVector.length;
    ...
    //Métodoso para vetores: '.reverse' para inverter a ordem inversa; .'.sort' ele organiza os vetores conforme as regras do JavaScriot; '.join' combina dois vetores; '.pop' remove o último elemento do vetor; '.push' acrescenta um item no  vetor; 
